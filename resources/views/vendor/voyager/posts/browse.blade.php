...
@section('page_header')
    <h1 class="page-title">
        ...
        @if (Voyager::can('add_'.$dataType->name))
            ...
            <a href="#" class="btn btn-success" onclick="event.preventDefault(); document.getElementById('formClearCache').submit()">ClearCache
                {!! Form::open(['route' => 'voyager.cache', 'id' => 'formClearCache', 'method'=>'delete']) !!}
                {!! Form::close() !!}
            </a>
        @endif
    </h1>
