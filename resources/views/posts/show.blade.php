...
@section('content')
  ...
  <li><a href="http://www.tumblr.com/share?v=3&u=http%3A%2F%2Fgrowthparty.co&t=&s=" target="_blank" title="Post to Tumblr" onclick="window.open('http://www.tumblr.com/share?v=3&u=' + encodeURIComponent(document.URL) + '&t=' +  encodeURIComponent(document.title)); return false;"><img alt="Post to Tumblr" src="growthparty.com/storage/Socialicons/tumblr.png"></a></li>
  ...
  <li><a href="mailto:?subject=&body=:%20http%3A%2F%2Fgrowthparty.co" target="_blank" title="Send email" onclick="window.open('mailto:?subject=' + encodeURIComponent(document.title) + '&body=' +  encodeURIComponent(document.URL)); return false;"><img alt="Send email" src="growthparty.co/images/flat_web_icon_set/black/email.png"></a></li>
</ul>
      {!! $post->body !!}
    </div>
  </div>
